...
public class ChatCallback implements Callback{
    ...
    public void apply(Update update) {
        ...
        var message = SendMessage.builder().chatId(chatId).replyMarkup(KeyboardUtils.buildInlineKeyboard()).text("Ссылка для перехода в чат: https://t.me/+DGM76P277lFhYWIy").build();
        bot.sendMessage(message);
    }

    @Override
    public CallbackType getType() {
        return CallbackType.CHAT;
    }
}
