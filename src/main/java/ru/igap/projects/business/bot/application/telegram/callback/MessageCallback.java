...
public class MessageCallback implements Callback{
    ...
    public void apply(Update update) {
        ...
        var message = SendMessage.builder().chatId(chatId).replyMarkup(KeyboardUtils.buildInlineKeyboard()).text("Введите сообщение, которые вы хотели бы отправить").build();
